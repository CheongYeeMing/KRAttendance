$(document).on("turbolinks:load", function () {
  ...
  +(function ($) {
    ...
    $(window).bind("load turbolinks:load", function () {
      $(Selector.data).each(function () {
        Plugin.call($(this));
      });
    });
  ...
  +(function ($) {
    ...
    PushMenu.prototype.toggle = function () {
      ...
      var sidebarid = $(".sidebar-toggle").attr("id");
      var isOpen = sidebarid == "sidebar";
      var hrefstr = window.location.href;
      console.log("triggered toggle");
      $(".main-header .sidebar-toggle").toggleClass("slideout");
      if (!isOpen) {
        this.open();
        console.log("push menu was not open & opening now");
        history.pushState(window.location.href, "", urlstring);
      } else {
        this.close();
        console.log("push menu was open & closing now");
        history.pushState(window.location.href, "", urlstring);
      }
    };
    ...
    PushMenu.prototype.open = function () {
      ...
      if (windowWidth > this.options.collapseScreenSize) {
        ...
        $(".sidebar-toggle").attr("id", "sidebar");
        console.log("open");
        console.log($(".sidebar-toggle").attr("id"));
      } else {
    ...
    PushMenu.prototype.close = function () {
      ...
      if (windowWidth > this.options.collapseScreenSize) {
        ...
        $(".sidebar-toggle").attr("id", "sidebar-collapse");
        console.log("close");
        console.log($(".sidebar-toggle").attr("id"));
      } else {
        $("body")
